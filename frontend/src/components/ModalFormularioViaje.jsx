...
const ModalFormularioViaje = () => {
  const { modalFormularioViaje, handleModalViaje, alerta } = useViajes();
  ...
  return (
    <Transition.Root show={modalFormularioViaje} as={Fragment}>
      <Dialog
        as="div"
        className="fixed z-10 inset-0 overflow-y-auto"
        onClose={handleModalViaje}
      >
...
export default ModalFormularioViaje;
